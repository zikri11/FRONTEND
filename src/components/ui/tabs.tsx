...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        'flex-1 outline-none transition-all data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-bottom-2 data-[state=active]:duration-500', 
        className
      )}
      {...props}
    />
